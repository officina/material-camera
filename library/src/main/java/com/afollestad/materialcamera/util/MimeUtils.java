...
public final class MimeUtils {
    ...
    /**
     * Returns the MIME type for file at the given content Uri.
     *
     * @param uri A content Uri
     * @return The MIME type for file at the given content Uri or null iff there is none.
     */
    public static String guessMimeTypeFromContentUri(Context context, Uri uri) {
